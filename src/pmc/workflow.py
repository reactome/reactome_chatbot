...
def build_workflow():
    ...
    workflow.add_node("transform_query_for_pmc", transform_query_for_pmc)
    ...
    workflow.add_conditional_edges("assess_completeness", decide_next_steps, 
                    ...
                    "transform_query_for_pmc": "transform_query_for_pmc",
                    "finish": END
                    },
                                )

    workflow.add_edge("transform_query_for_pmc", "perform_pmc_search")
    workflow.add_edge("perform_web_search", "format_external_results")
    workflow.add_edge("perform_pmc_search", "format_external_results")
