...
def reciprocal_rank_fusion(
    ...
    This function is used across all retrieval systems (Reactome, UniProt, GraphRAG)
    ...
    Args:
        ...
        lambda_mult: Lambda multiplier for RRF scoring
        rrf_k: Maximum number of results per list to consider
        id_getter: Function to extract document ID from items
        
    Returns:
        Tuple of (top_docs, top_ids, rrf_scores)
    """
