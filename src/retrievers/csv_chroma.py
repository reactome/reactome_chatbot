...
from retrievers.graph_rag.retrieval_utils import reciprocal_rank_fusion
...
def discover_chroma_subdirectories(directory: Path) -> List[str]:
...
class HybridRetriever:
    ...
    def _initialize_retrievers(self) -> None:
        ...
        subdirectories = discover_chroma_subdirectories(self.embeddings_directory)
