...
class AgentGraph:
    def __init__(
        ...
        llm: BaseChatModel = get_llm("openai", llm_model, base_url=llm_base_url, request_timeout=360.0)
        embedding_base_url = os.getenv("OPENAI_BASE_URL", None)
        embedding: Embeddings = get_embedding("openai", embedding_model, base_url=embedding_base_url)
